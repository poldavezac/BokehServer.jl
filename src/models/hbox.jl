...
@model mutable struct HBox <: iHBox
    ...
    children :: Vector{NamedTuple{(:child, :col, :span), Tuple{iUIElement, Int64, Int64}}} = NamedTuple{(:child, :col, :span), Tuple{iUIElement, Int64, Int64}}[]
