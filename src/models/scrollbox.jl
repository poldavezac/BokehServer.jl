...
@model mutable struct ScrollBox <: iScrollBox
    ...
    horizontal_scrollbar :: Model.EnumType{(:auto, :visible, :hidden)} = :auto
    ...
    vertical_scrollbar :: Model.EnumType{(:auto, :visible, :hidden)} = :auto
