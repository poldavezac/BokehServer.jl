...
precompile(Tuple{BokehJL.Server.var"#14#15"{Sockets.TCPServer, Base.Dict{Symbol, BokehJL.Server.iRoute}}, HTTP.Streams.Stream{HTTP.Messages.Request, HTTP.ConnectionPool.Connection}})
