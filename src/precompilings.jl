...
precompile(Tuple{BokehJL.Model.var"#99#101"{BokehJL.Model.EnumType{(:above, :below)}}, Type})
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.FigureOptions, Symbol, BokehJL.Model.EnumType{(:above, :below)}}, Type})
...
precompile(Tuple{BokehJL.Plotting.AxesPlotting.var"#addaxis!##kw", NamedTuple{(:type, :range, :location, :num_minor_ticks, :label, :dotrigger), Tuple{Symbol, Nothing, Symbol, Base.Missing, String, Bool}}, typeof(BokehJL.Plotting.AxesPlotting.addaxis!), BokehJL.Models.Plot, Symbol})
...
precompile(Tuple{BokehJL.Plotting.AxesPlotting.var"#addaxis!##kw", NamedTuple{(:location, :dotrigger), Tuple{Symbol, Bool}}, typeof(BokehJL.Plotting.AxesPlotting.addaxis!), BokehJL.Models.Plot, NamedTuple{(:axis, :rangename, :axisname, :range, :scale, :axes, :grids), Tuple{Symbol, String, Base.Missing, BokehJL.Models.DataRange1d, BokehJL.Models.LinearScale, Array{BokehJL.Models.iAxis, 1}, Array{BokehJL.Models.Grid, 1}}}})
precompile(Tuple{BokehJL.Model.var"#99#101"{BokehJL.Model.EnumType{(:left, :right)}}, Type})
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.FigureOptions, Symbol, BokehJL.Model.EnumType{(:left, :right)}}, Type})
...
precompile(Tuple{BokehJL.Plotting.GlyphPlotting.var"#20#21"{Base.Dict{String, AbstractArray{T, N} where N where T}}, Symbol, Array{Int64, 1}, BokehJL.Model.Unknown, Type})
precompile(Tuple{BokehJL.Plotting.GlyphPlotting.var"#20#21"{Base.Dict{String, AbstractArray{T, N} where N where T}}, Symbol, Base.UnitRange{Int64}, BokehJL.Model.Unknown, Type})
...
precompile(Tuple{BokehJL.Plotting.GlyphPlotting.var"#20#21"{Base.Dict{String, AbstractArray{T, N} where N where T}}, Symbol, Float64, BokehJL.Model.SizeSpec, Type})
precompile(Tuple{BokehJL.Plotting.GlyphPlotting.var"#20#21"{Base.Dict{String, AbstractArray{T, N} where N where T}}, Symbol, Float64, BokehJL.Model.AngleSpec, Type})
precompile(Tuple{BokehJL.Plotting.GlyphPlotting.var"#20#21"{Base.Dict{String, AbstractArray{T, N} where N where T}}, Symbol, Symbol, BokehJL.Model.MarkerSpec, Type})
...
precompile(Tuple{BokehJL.Model.var"#99#101"{BokehJL.Model.Color}, Type})
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.BoxAnnotation, Symbol, BokehJL.Model.Color}, Type})
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.UnionRenderers, Symbol, Nothing}, Type})
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.LinearAxis, Symbol, BokehJL.Model.Color}, Type})
...
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.Line, Symbol, BokehJL.Model.Color}, Type})
...
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.Plot, Symbol, BokehJL.Model.Color}, Type})
precompile(Tuple{BokehJL.Model.var"#99#101"{Int64}, Type})
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.Plot, Symbol, Int64}, Type})
precompile(Tuple{BokehJL.Model.var"#99#101"{Tuple{Int64, Int64, Int64, Int64}}, Type})
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.Plot, Symbol, Tuple{Int64, Int64, Int64, Int64}}, Type})
...
precompile(Tuple{BokehJL.Model.var"#99#101"{BokehJL.Model.EnumType{(:above, :below, :left, :right)}}, Type})
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.Plot, Symbol, BokehJL.Model.EnumType{(:above, :below, :left, :right)}}, Type})
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.AllLabels, Symbol, Nothing}, Type})
precompile(Tuple{BokehJL.Model.var"#99#101"{BokehJL.Model.EnumType{(:normal, :grey)}}, Type})
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.Toolbar, Symbol, BokehJL.Model.EnumType{(:normal, :grey)}}, Type})
...
precompile(Tuple{BokehJL.Model.var"#99#101"{BokehJL.Models.LinearAxis}, Type})
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.Grid, Symbol, BokehJL.Models.LinearAxis}, Type})
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.Grid, Symbol, Nothing}, Type})
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.Grid, Symbol, BokehJL.Model.Color}, Type})
...
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.HelpTool, Symbol, String}, Type})
precompile(Tuple{BokehJL.Model.var"#98#100"{BokehJL.Models.HelpTool, Symbol, Nothing}, Type})
precompile(Tuple{BokehJL.Protocol.PatchDocReceive.var"#9#10"{String}, Base.Dict{String, Any}})
precompile(Tuple{BokehJL.Protocol.PatchDocReceive.var"#5#6"{BokehJL.Protocol.PatchDocReceive._Models}, Pair{String, Any}})
precompile(Tuple{BokehJL.Protocol.PatchDocReceive.var"#13#14"{BokehJL.Protocol.PatchDocReceive._Models, DataType}, Int64})
precompile(Tuple{BokehJL.Protocol.PatchDocReceive.var"#13#14"{BokehJL.Protocol.PatchDocReceive._Models, DataType}, Base.Dict{String, Any}})
end
using .Precompilings
