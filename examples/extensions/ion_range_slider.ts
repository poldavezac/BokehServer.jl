...
export class IonRangeSliderView extends InputWidgetView {
  ...
  render(): void {
    ...
    l1.setAttribute('href', 'https://cdnjs.cloudflare.com/ajax/libs/ion-rangeslider/2.1.4/css/ion.rangeSlider.css')
    this.group_el.appendChild(l1)

    const l2 = document.createElement('link')
    l2.setAttribute('rel', 'stylesheet')
    l2.setAttribute('href', 'https://cdnjs.cloudflare.com/ajax/libs/ion-rangeslider/2.1.4/css/ion.rangeSlider.skinFlat.min.css')
    this.group_el.appendChild(l2)
