...
module CodeCreator
module BokehJL
# a very simplified BokehJL for parsing bokeh
...
const _BM_PATT  = (r"BokehJL\.Models\." => "i", r"(CodeCreator\.)*?BokehJL\." => "", r"CodeCreator\." => "")
...
function createcode(; adddoc ::Symbol = :none)
    ...
    file(f, x...) = open(joinpath((@__DIR__), "..", "..", "src", x...), "w") do io
        println(io, "#- file generated by BokehJL's '$(@__MODULE__)': edit at your own risk! -#")
        f(io)
    end
